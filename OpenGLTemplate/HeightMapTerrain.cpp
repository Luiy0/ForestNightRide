...
bool CHeightMapTerrain::GetImageBytes(char const*terrainFilename, BYTE **bDataPointer, unsigned int &width, unsigned int &height)
{
...
bool CHeightMapTerrain::Create(char const *terrainFilename, char const *textureFilename, glm::vec3 origin, float terrainSizeX, float terrainSizeZ, float terrainHeightScale)
{
	BYTE *bDataPointer;
